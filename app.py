...
for column in X_train.columns: # Створюємо поле введення для кожної ознаки.
    user_input[column] = st.number_input(f"{column}", value=0.0) # Значення за замовчуванням = 0.0.
